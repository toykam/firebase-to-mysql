...
connection.connect((error) => {
    ...
    admin.firestore().collection('transactions').get().then((result) => {
        ...
        result.docs.forEach((doc) => {
            ...
            var sql = `INSERT INTO transactions (commission, key_to_use, l_version, live_url, paystack_public_key, paystack_public_test_key, paystack_secret_key, paystack_secret_test_key, test_url, url_to_use, vt_password, vt_username)`;
